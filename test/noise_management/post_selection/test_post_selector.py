...
class TestPostSelector(unittest.TestCase):
    """Tests for ``PostSelector``."""
    ...
    def test_node_based_post_selection(self):
        ...
        alpha_ps1 = ~alpha
        beta_ps1 = ~beta
        # In shot `0`, these failures occurr on two non-neighboring qubits -> shot discarded
        alpha_ps1[0, 0, 0] = alpha[0, 0, 0]
        alpha_ps1[0, 0, 2] = alpha[0, 0, 2]
        # Also in shot `3` these failures occurr on two non-neighboring qubits -> shot discarded
        alpha_ps1[5, 3, 1] = alpha[5, 3, 1]
        beta_ps1[5, 3, 0] = beta[5, 3, 0]
        # In shot `10`, these failures occurr on two neighboring qubits -> shot discarded
    ...
    def test_edge_based_post_selection(self):
        ...
        alpha_ps1 = ~alpha
        beta_ps1 = ~beta
        # In shot `0`, these failures occurr on two non-neighboring qubits -> shot kept
        alpha_ps1[0, 0, 0] = alpha[0, 0, 0]
        alpha_ps1[0, 0, 2] = alpha[0, 0, 2]
        # Also in shot `3` these failures occurr on two non-neighboring qubits -> shot kept
        alpha_ps1[5, 3, 1] = alpha[5, 3, 1]
        beta_ps1[5, 3, 0] = beta[5, 3, 0]
        # In shot `10`, these failures occurr on two neighboring qubits -> shot discarded
        alpha_ps1[1, 10, 0] = alpha[1, 10, 0]
