...
from qiskit_addon_utils.noise_management.bitflip_checks import PostSelectionSummary
...
def test_from_circuit_does_not_recurse_into_control_flow_ops():
    ...
    running ``AddPostCircuitBitFlipChecks`` on a samplomatic-style boxed circuit)
