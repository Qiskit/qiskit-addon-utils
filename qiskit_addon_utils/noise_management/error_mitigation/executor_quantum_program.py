...
class ExecutorQuantumProgramItem(abc.ABC):
    """An item of a :class:`ExecutorQuantumProgram`.
...
class ExecutorCircuitItem(ExecutorQuantumProgramItem):
    """An item of a :class:`ExecutorQuantumProgram` containing a circuit and its arguments.
    ...
    def __repr__(self) -> str:
        ...
        return f"ExecutorQuantumProgramSimpleItem({circuit}{circuit_args})"


class ExecutorSamplexItem(ExecutorQuantumProgramItem):
    """An item of a :class:`ExecutorQuantumProgram` containing a circuit and samplex to feed it arguments.
    ...
    def __repr__(self) -> str:
        ...
        return f"ExecutorQuantumProgramSamplexItem({circuit}{samplex}{samplex_args}{shape})"


class ExecutorQuantumProgram:
    """A program containing quantum execution items.

    A quantum program consists of a list of ordered elements, each of which contains a single
    circuit and an array of associated parameter values. For execution, should be converted to
    the relevant providers' format. For example, to execute a program using ibm_runtime, the instance
    should be converted to the similar `QuantumProgram` class of `qiskit_ibm_runtime`.
    Executing a quantum program will sample the outcome of each circuit for the specified number of
    ``shots`` for each set of circuit arguments provided.
    ...
    def append_circuit_item(
        ...
        *,
        ...
        """Append a new :class:`ExecutorCircuitItem` to this program.
    ...
    def append_samplex_item(
        ...
        *,
        ...
        """Append a new :class:`ExecutorSamplexItem` to this program.
